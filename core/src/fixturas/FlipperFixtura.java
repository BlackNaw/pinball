...
public class FlipperFixtura extends MyFixture{
	...
	public Body createIrregular(World world,BodyType bodyType,float posx,float posy,String jsonPath,float width,String fixtureName){
...
//		(Body body,float radius,BodyDef.BodyType bodyType,float density,float restitution,float angle,float friction)
	...
	public Body createBoxBody(World world,BodyType bodyType,float posx,float posy,float width,float height){
		...
		bodyDef.position.set((posx) / BOX_TO_WORLD,
				(posy) / BOX_TO_WORLD);
